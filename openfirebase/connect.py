"""Native cognis-connect emit for openfirebase — forward findings to any platform.

Maps openfirebase's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    openfirebase ... --format json | openfirebase-emit --to stix
    openfirebase-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
